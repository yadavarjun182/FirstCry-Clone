...
import { shopbycatgirl,shopbycalboy, fashion, footware, shopbyage, shopbyprice, shopbybrands } from './Navbar2'
...
const GirlsFashion = () => {
  return (
    ...
    <Addcartscroll>
      ...
      <SimpleGrid minChildWidth='220px' spacing='10px'>
        ...
        <Box maxWidth={"350px"} >
                <Image  src="https://cdn.fcglcdn.com/brainbees/images/n/desktop_drop_down_girl_sio_060123.jpg" alt="girls fashion"/>
        </Box>
    </SimpleGrid>
  ...
  </Popover></GirlsFashionWrapper>
  )
}

export default GirlsFashion

const GirlsFashionWrapper = styled.div`
h1{
    font-weight: bolder;
    text-align: left;
}
